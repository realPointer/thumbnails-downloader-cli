...
func (c *thumbnailServiceClient) DownloadThumbnail(ctx context.Context, in *DownloadThumbnailRequest, opts ...grpc.CallOption) (*DownloadThumbnailResponse, error) {
	out := new(DownloadThumbnailResponse)
	err := c.cc.Invoke(ctx, "/thumbnail.ThumbnailService/DownloadThumbnail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedThumbnailServiceServer) DownloadThumbnail(context.Context, *DownloadThumbnailRequest) (*DownloadThumbnailResponse, error) {
...
func _ThumbnailService_DownloadThumbnail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/thumbnail.ThumbnailService/DownloadThumbnail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThumbnailServiceServer).DownloadThumbnail(ctx, req.(*DownloadThumbnailRequest))
	}
